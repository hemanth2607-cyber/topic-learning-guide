...
class GrokEngine:
    ...
    def _get_prompts(self, level: str, topic: str):
        tag_instruction = (
            ...
            "3. RESOURCE LINKING RULE:\\n"
            "   - For any online resource (such as e-books, websites, documentation, or online courses), you MUST format it as a clickable Markdown link containing a 🔗 icon. "
            "For example: '[Course Name 🔗](https://example.com/...)'. Use high-quality, realistic domains (e.g., books.google.com, amazon.com, geeksforgeeks.org, coursera.org, etc.).\\n"
            "   - For physical/offline resources (such as hardback textbooks or standard print copies), do NOT create a hyperlink. "
            "Instead, append ' [📖 Physical Copy Only]' next to the title.\\n"
